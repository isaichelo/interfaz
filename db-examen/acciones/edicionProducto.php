...
<body>
  ...
  <form action="editarProducto.php" method="POST">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" name="N" value="<?php echo $fila["nombre"]?>" />
    </div>



    <div class="mb-3">
      <label class="form-label">Editar el precio del producto</label>
      <input type="text" class="form-control" name="P" value="<?php echo $fila["precio"]?>" />
    </div>
